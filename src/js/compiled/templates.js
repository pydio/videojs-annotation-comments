...
exports["comment_list"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"vac-comments-container\">\n  <div class=\"vac-comments-wrap\">\n"
    ...
    + "    <div class=\"vac-reply-btn vac-button\">"
    + alias3((helpers.I18n || (depth0 && depth0.I18n) || alias2).call(alias1,"comment.reply",{"name":"I18n","hash":{},"data":data,"blockParams":blockParams}))
    + "</div>\n    <div class=\"vac-add-new-shapebox\"></div>\n  </div>\n  <div class=\"vac-comments-control-bar\">\n    <div class=\"vac-range\"><b>@</b> "
    + alias3(((helper = (helper = helpers.rangeStr || (depth0 != null ? depth0.rangeStr : depth0)) != null ? helper : alias2),(typeof helper === "function" ? helper.call(alias1,{"name":"rangeStr","hash":{},"data":data,"blockParams":blockParams}) : helper)))
    + "</div>\n    <div class=\"vac-control-buttons\">\n      <a class=\"vac-delete-annotation\">"
    + alias3((helpers.I18n || (depth0 && depth0.I18n) || alias2).call(alias1,"comment.delete",{"name":"I18n","hash":{},"data":data,"blockParams":blockParams}))
    + "</a> | <a class=\"vac-close-comment-list\">"
    + alias3((helpers.I18n || (depth0 && depth0.I18n) || alias2).call(alias1,"comment.close",{"name":"I18n","hash":{},"data":data,"blockParams":blockParams}))
    + "</a>\n    </div>\n  </div>\n</div>\n";
...
exports["controls"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        <div class=\"vac-controls vac-control\">\n            <button class=\"vac-button\">"
    + container.escapeExpression((helpers.I18n || (depth0 && depth0.I18n) || helpers.helperMissing).call(alias1,"controls.new",{"name":"I18n","hash":{},"data":data}))
    + "</button>\n"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.showNav : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "        </div>\n";
},"3":function(container,depth0,helpers,partials,data) {
    var alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=helpers.helperMissing, alias3=container.escapeExpression;

  return "                <div class=\"vac-annotation-nav\">\n                    <div class=\"vac-a-prev\">"
    + alias3((helpers.I18n || (depth0 && depth0.I18n) || alias2).call(alias1,"controls.prev",{"name":"I18n","hash":{},"data":data}))
    + "</div>\n                    <div class=\"vac-a-next\">"
    + alias3((helpers.I18n || (depth0 && depth0.I18n) || alias2).call(alias1,"controls.next",{"name":"I18n","hash":{},"data":data}))
    + "</div>\n                </div>\n";
},"5":function(container,depth0,helpers,partials,data) {
    var stack1, alias1=depth0 != null ? depth0 : (container.nullContext || {});

  return "    <div class=\"vac-video-cover vac-control\">\n        <div class=\"vac-video-cover-canvas\">\n            <div class=\"vac-cursor-tool-tip vac-hidden\">"
    + container.escapeExpression((helpers.I18n || (depth0 && depth0.I18n) || helpers.helperMissing).call(alias1,"controls.dragtoselect",{"name":"I18n","hash":{},"data":data}))
    + "</div>\n        </div>\n    </div>\n"
  ...
  return "        <div class=\"vac-add-controls vac-control\">\n            <i>"
    + container.escapeExpression((helpers.I18n || (depth0 && depth0.I18n) || helpers.helperMissing).call(alias1,"controls.selectshaperange",{"name":"I18n","hash":{},"data":data}))
    + "</i>\n"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.internalCommenting : depth0),{"name":"if","hash":{},"fn":container.program(7, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "            <div class=\"vac-video-move\">\n                <div class=\"vac-a-prev\">-1 sec</div>\n                <div class=\"vac-a-next\">+1 sec</div>\n            </div>\n        </div>\n";
},"7":function(container,depth0,helpers,partials,data) {
    return "                <button class=\"vac-button\">"
    + container.escapeExpression((helpers.I18n || (depth0 && depth0.I18n) || helpers.helperMissing).call(depth0 != null ? depth0 : (container.nullContext || {}),"controls.continue",{"name":"I18n","hash":{},"data":data}))
    + "</button>\n                <a>cancel</a>\n";
  ...
  return "        <div class=\"vac-video-write-new-wrap vac-control\">\n            <div class=\"vac-video-write-new vac-is-annotation\">\n                <div>\n                    <h5><b>"
    + alias3((helpers.I18n || (depth0 && depth0.I18n) || alias2).call(alias1,"comment.new",{"name":"I18n","hash":{},"data":data}))
    + "</b> @ "
    + alias3(((helper = (helper = helpers.rangeStr || (depth0 != null ? depth0.rangeStr : depth0)) != null ? helper : alias2),(typeof helper === "function" ? helper.call(alias1,{"name":"rangeStr","hash":{},"data":data}) : helper)))
    + "</h5>\n                    <div class=\"vac-comment-showbox\">\n                        <textarea placeholder=\""
    + alias3((helpers.I18n || (depth0 && depth0.I18n) || alias2).call(alias1,"comment.placeholder",{"name":"I18n","hash":{},"data":data}))
    + "\"></textarea>\n                        <div>\n                            <button class=\"vac-button\">"
    + alias3((helpers.I18n || (depth0 && depth0.I18n) || alias2).call(alias1,"comment.save",{"name":"I18n","hash":{},"data":data}))
    + "</button>\n                            <a>"
    + alias3((helpers.I18n || (depth0 && depth0.I18n) || alias2).call(alias1,"comment.cancel",{"name":"I18n","hash":{},"data":data}))
    + "</a>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n";
...
exports["new_comment"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"vac-video-write-new-wrap vac-new-comment\">\n  <div class=\"vac-video-write-new vac-is-comment\">\n    <div class=\"vac-comment-showbox\" style=\"width:"
    ...
    + "px\">\n      <textarea placeholder=\""
    + alias4((helpers.I18n || (depth0 && depth0.I18n) || alias2).call(alias1,"comment.placeholder",{"name":"I18n","hash":{},"data":data}))
    + "\"></textarea>\n      <div>\n        <button class=\"vac-button\">"
    + alias4((helpers.I18n || (depth0 && depth0.I18n) || alias2).call(alias1,"comment.save",{"name":"I18n","hash":{},"data":data}))
    + "</button>\n        <a>Cancel</a>\n      </div>\n    </div>\n</div>\n";
},"useData":true});
